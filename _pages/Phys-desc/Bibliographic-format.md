...
<a name="6.29.1.1">6.29.1.1</a> [Link to RDA Toolkit](https://access.rdatoolkit.org/Content/Index?externalId=en-US_ala-bfeb2cbe-ffdc-34b7-a147-c590b4e03997){:target="_blank"}
...
<a name="6.29.3.1">6.29.3.1</a> For hand-press publications, record the bibliographic format of the manifestation whenever the format can be determined. *Optionally*, give the format for machine-press publications. Record the format using one or more terms from the [RDA Value Vocabularies: RDA Bibliographic Format](http://www.rdaregistry.info/termList/bookFormat/){:target="_blank"} and indicate the source. Use "full-sheet" for manifestations made up of unfolded sheets.
...
<a name="6.29.3.2">6.29.3.2</a> If none of the terms in the RDA Value Vocabularies: RDA Bibliographic Format is appropriate, record a suitable term from another standardized vocabulary and indicate its source.
